...
# ================================================
# GROQ API SETUP (Vercel Safe)
# ================================================
GROQ_API_KEY = os.getenv("GROQ_API_KEY")

if not GROQ_API_KEY:
    raise ValueError("GROQ_API_KEY environment variable is not set. Please add it in Vercel Dashboard.")
...
# # GROQ API SETUP
# # ================================================
# GROQ_API_KEY = os.getenv("GROQ_API_KEY", "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")
# client = Groq(api_key=GROQ_API_KEY)
